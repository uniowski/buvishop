          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md">
              <input
                ...
                className="flex-1 px-4 py-2 rounded-md text-slate-900 border-none focus:outline-none focus:ring-2 focus:ring-white/20"
              />
              <Button className="bg-white text-slate-900 hover:bg-gray-100 whitespace-nowrap">
                Subscribe
              </Button>
            </div>
          </div>
